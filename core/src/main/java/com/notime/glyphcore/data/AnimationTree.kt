...
object AnimationTree {
    ...
    val nodes: List<AnimationNode> = buildList {
        ...
        leaf("sport/ballsport/dribbling", "🤾", null)
        leaf("sport/ballsport/schuss", "🥅", null)
        ...
        leaf("sport/kraft-ausdauer/heben", "💪", null)
        ...
        sub("koerper/essen", "🍽️", R.string.node_koerper_essen, null)
        ...
        leaf("arbeit/geraet/pause-machen", "⏸️", null)
        ...
        leaf("lernen/lesen/notizen", "📝", null)
        ...
        leaf("kreativ/musik/singen", "🎤", null)
        ...
        leaf("naehe/freunde/besuch", "🚪", null)
        leaf("naehe/freunde/anrufen", "📞", null)
        ...
        leaf("aufbruch/reisen/karte", "🗺️", null)
        sub("aufbruch/feiern", "🎂", R.string.node_aufbruch_feiern, "Cake")
        leaf("aufbruch/feiern/konfetti", "🎊", null)
        leaf("aufbruch/feiern/kerzen", "🕯️", null)
    }
